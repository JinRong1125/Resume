...
### 概要
Android エンジニアとして約 ６ 年の開発経験を持ち、主にマルチメディア系のアプリ開発に携わってきました。現職ではユーザー数百万人の Gunosy Android アプリ開発を担当しています。今後も Android 技術を通じて技術スタックを積み上げ、幅広いサービスの開発に挑み続けたいと思っています。
# 職務経歴
...
### 弱み
 - 人のマネジメント
   - まず技術に関する相談を乗れるような人になり、徐々にテックリードを目指す
 - プロジェクトのリーダシップ
   - 小さい施策から、技術スタックを広げることに連れて、大きいスケールのプロジェクトに携わって行きたい
 - 施策の計画・提案
   - 技術を活かした上で、今後新たな課題や成長させる提案に挑戦したい
### 将来像
