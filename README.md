...
### 概要
Android エンジニアとして、約 8 年モバイルアプリの開発経験を持ち、主にマルチメディア系のアプリ開発に携わってきました。今後も Android 技術を通じて技術スタックを積み上げ、幅広いサービスの開発に挑み続けたいと思っています。
# 職務経歴
...
### プロジェクト概要
 - チーム規模：10 人
 - 役割：R&D エンジニア
 - 目的：対話型 LLM を起点に、ユーザーが自然言語からプレゼン動画を自動生成できる仕組みの実証（POC）
### 主な業務と成果
#### AIサービスの技術検証と価値提供の評価
 - ボイスクローン・アバター動画・音楽生成の各 AI サービスについて、出力品質と安定性を比較検証
...
#### AI動画生成のアプリ構築
 ...
 - 対話型LLMを用いて、ユーザー入力から動画構成を生成する一連のパイプラインを設計
...
### 弱み
 - 人のマネジメント
   - まず技術に関する専門分野で信頼されるようになり、常にメンバーを後押しするリードエンジニアを目指す
 - プロジェクトのリーダシップ
